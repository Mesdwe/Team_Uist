Shader "LowPolyWater/WaterShade2" {
Properties { 
	...
	_CurveIntensity ("Curve Intensity",Float)=0
	_Offset ("Offset",Vector) =(-1000,0,0,0)
...
CGINCLUDE 
	...
	v2f vert(appdata_full v)
	{
		...
		o.pos = GetFixedRollClipPos(v.vertex,_CurveIntensity,_Offset);
		return o;
	}
