Shader "LowPolyWater/WaterShaded3" {
Properties { 
	...
	_CurveIntensityZ ("Curve Intensity Z", Range(0.0,1.0)) = 0.0005
	_CurveIntensityX ("Curve Intensity Z", Range(0.0,1.0)) = 0.0005
	_OffsetX ("Offset X",Vector) =(-750,0,0)
...
CGINCLUDE 
	...
	float change;
	float _CurveIntensityZ;
	float _CurveIntensityX;
	float3 _OffsetX;
	...
	v2f vert(appdata_full v)
	{
        ...
        o.pos = GetFixedRollClipPos(v.vertex,_CurveIntensityZ,_OffsetX);
